...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate, SaveTeamDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let controller = (segue.destination as! UINavigationController).topViewController as! NewTeamViewController
    ...
    var _fetchedResultsController: NSFetchedResultsController<Team>? = nil
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
        switch type {
            ...
            case .update:
                self.configureCell(tableView.cellForRow(at: indexPath!)!, withTeam: anObject as! Team)
            case .move:
